...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _QuestionBankList = __webpack_require__(159);

	var _QuestionBankList2 = _interopRequireDefault(_QuestionBankList);

	var _AddQuestionBankForm = __webpack_require__(161);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'addQuestionBank',
	    value: function addQuestionBank(questionBank) {
	      var allQuestionBanks = this.state.questionBanks.concat([questionBank]);
	      this.setState({
	    ...
	    value: function deleteQuestionBank(index) {
	      var finalQuestionBanks = this.state.questionBanks.filter(function (d, i) {
	        return i !== index;
	      });
	      this.setState({
	    ...
	    key: 'editQuestionBank',
	    value: function editQuestionBank(index) {
	      var editingData = this.state.questionBanks[index];
	    ...
	    key: 'editQuestionBankComplete',
	    value: function editQuestionBankComplete(index, questionBank) {
	      var questionBanks = this.state.questionBanks;
	    ...
	    value: function render() {
	      ...
	      if (this.state.editingData !== '') {
	        editForm = _react2.default.createElement(_EditQuestionBankForm2.default, {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'well list-left-accordion' },
	            _react2.default.createElement(_QuestionBankList2.default, {
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'addq-container' },
	              _react2.default.createElement(
	                'button',
	                { type: 'button', className: 'btn btn-add addq', onClick: this.onclick.bind(this, this.state.active) },
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'col-sm-12 col-md-8 list-right' },
	          _react2.default.createElement(_AddQuestionBankForm2.default, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _QuestionBankDetail = __webpack_require__(160);

	var _QuestionBankDetail2 = _interopRequireDefault(_QuestionBankDetail);
	...
	var QuestionBankList = function (_Component) {
	  _inherits(QuestionBankList, _Component);

	  function QuestionBankList() {
	    _classCallCheck(this, QuestionBankList);

	    var _this = _possibleConstructorReturn(this, (QuestionBankList.__proto__ || Object.getPrototypeOf(QuestionBankList)).call(this));

	    _this.state = { mounted: false };
	    return _this;
	  }

	  _createClass(QuestionBankList, [{
	    ...
	    key: 'deleteQuestionBank',
	    value: function deleteQuestionBank(id) {
	      this.props._removeQuestionBank(id);
	    }
	  }, {
	    key: 'editQuestionBank',
	    value: function editQuestionBank(id) {
	    ...
	    value: function render() {
	      ...
	      var questionBankNames = "";
	      if (this.state.mounted) {
	        if (this.props.questionBanks.length === 0) {
	          questionBankNames = _react2.default.createElement(
	            'h4',
	            null,
	            '* No questionBank yet'
	          );
	        } else {
	          questionBankNames = this.props.questionBanks.map(function (data, index) {
	            return _react2.default.createElement(_QuestionBankDetail2.default, {
	              item: data,
	              key: index,
	              id: index,
	              _deleteQuestionBank: _this2.deleteQuestionBank.bind(_this2),
	              _editQuestionBank: _this2.editQuestionBank.bind(_this2) });
	          });
	        }
	      }
	...
	exports.default = QuestionBankList;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var QuestionBankDetail = function (_Component) {
	  _inherits(QuestionBankDetail, _Component);

	  function QuestionBankDetail(props) {
	    _classCallCheck(this, QuestionBankDetail);

	    return _possibleConstructorReturn(this, (QuestionBankDetail.__proto__ || Object.getPrototypeOf(QuestionBankDetail)).call(this, props));
	  }

	  _createClass(QuestionBankDetail, [{
	    key: "deleteQuestionBank",
	    value: function deleteQuestionBank() {
	      this.props._deleteQuestionBank(this.props.id);
	    }
	  }, {
	    key: "editQuestionBank",
	    value: function editQuestionBank() {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        { className: "panel panel-default", key: "questionBank-" + this.props.id },
	        _react2.default.createElement(
	          "div",
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "a",
	              {
	                ...
	                href: "#questionBank-" + this.props.id },
	        ...
	        _react2.default.createElement(
	          "div",
	          { id: "questionBank-" + this.props.id, className: "panel-collapse collapse" },
	          _react2.default.createElement(
	            "div",
	...
	exports.default = QuestionBankDetail;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddQuestionBankForm = function (_Component) {
	  _inherits(AddQuestionBankForm, _Component);

	  function AddQuestionBankForm(props) {
	    _classCallCheck(this, AddQuestionBankForm);
	  ...
	  _createClass(AddQuestionBankForm, [{
	    key: 'handleAddQuestionBank',
	    value: function handleAddQuestionBank(e) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'form-horizontal list-right-form', role: 'form',
	  ...
	  return AddQuestionBankForm;
	}(_react.Component);

	;

	exports.default = AddQuestionBankForm;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EditQuestionBankForm = function (_Component) {
	  _inherits(EditQuestionBankForm, _Component);

	  function EditQuestionBankForm(props) {
	    _classCallCheck(this, EditQuestionBankForm);

	    var _this = _possibleConstructorReturn(this, (EditQuestionBankForm.__proto__ || Object.getPrototypeOf(EditQuestionBankForm)).call(this, props));
	  ...
	  _createClass(EditQuestionBankForm, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var u = [];
	    ...
	    key: 'handleEditQuestionBank',
	    value: function handleEditQuestionBank(e) {
	      e.preventDefault();

	      var answersArray = this.props.data.answers;
	      var question = this.refs.question.value.trim();
	      var refs = $.extend(true, {}, this.refs);
	      console.log(refs);
	      delete refs.question;
	    ...
	    key: 'changeQuestion',
	    value: function changeQuestion(e) {
	      this.setState({ question: e.target.value });
	    }
	  }, {
	    key: 'changeAnswers',
	    value: function changeAnswers(e) {
	      console.log(this.refs);
	    }
	  }, {
	    key: 'render',
